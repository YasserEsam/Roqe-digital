...
const NewsLatterBox = () => {
  ...
  // Don't render SVGs until component is mounted and theme is determined
  if (!mounted) {
    return (
      <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
        <div className="h-[400px] w-full animate-pulse"></div>
      </div>
    );
  }
  ...
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      ...
      {/* Decorative elements - now with consistent theme colors */}
      <div>
